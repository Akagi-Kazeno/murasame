<template>
  <view :class="[styleType === 'text'?'segmented-control--text' : 'segmented-control--button' ]"
    ...
    <view v-for="(item, index) in values" :key="index" :class="[ styleType === 'text' ? '': 'segmented-control__item--button',
      ...
      <view>
        <text :class="styleType === 'text' && index === currentIndex ? 'segmented-control__item--text': ''" :style="{color:
				    index === currentIndex
				      ? styleType === 'text'
				        ? activeColor
				        : '#fff'
