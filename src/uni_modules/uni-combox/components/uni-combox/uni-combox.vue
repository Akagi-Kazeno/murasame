<template>
  <view :class="border ? '' : 'uni-combox__no-border'" class="uni-combox">
    ...
    <view v-if="showSelector" class="uni-combox__selector">
      ...
      <scroll-view class="uni-combox__selector-scroll" scroll-y="true" @scroll="onScroll">
    ...
    <!-- 新增蒙层，点击蒙层时关闭选项显示 -->
    <view v-show="showSelector" class="uni-combox__mask" @click="showSelector = false"></view>
  </view>
</template>
