<template>
  <view class="uni-date">
    ...
    <view v-if="!isPhone" v-show="pickerVisible" ref="datePicker" class="uni-date-picker__container">
      <view v-if="!isRange" :style="pickerPositionStyle" class="uni-date-single--x">
        ...
        <view v-if="hasTime" class="uni-date-changed popup-x-header">
          <input v-model="inputDate" :placeholder="selectDateText" class="uni-date__input text-center"
                 type="text" />
      ...
      <view v-else :style="pickerPositionStyle" class="uni-date-range--x">
        ...
        <view class="popup-x-body">
          <Calendar ref="left" :end-date="calendarRange.endDate" :pleStatus="endMultipleStatus"
                    ...
                    style="padding: 0 8px;" @change="leftChange" @firstEnterCale="updateRightCale" />
    ...
    <Calendar v-if="isPhone" ref="mobile" :clearDate="false" :date="calendarDate" :defTime="mobileCalendarTime"
              ...
              :hasTime="hasTime" :hideSecond="hideSecond"
              :insert="false"
